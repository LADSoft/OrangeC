...
CFLAGS := $(CCFLAGS) $(CINCLUDES) $(DEFINES) -DGNUC -D_WIN32_IE=0x600 -D_WIN32_WINNT=0x500 -DWINVER=0x500
CXXFLAGS := $(CCFLAGS) $(CINCLUDES) $(DEFINES) -DGNUC -D_WIN32_IE=0x600 -D_WIN32_WINNT=0x500 -DWINVER=0x500 -std=c++14
