...
extern "C"
{
    ...
    UINT PASCAL WINBASEAPI waveOutOpen(LPHWAVEOUT phwo, UINT uDeviceID, LPCWAVEFORMATEX pwfx, DWORD dwCallback, DWORD dwInstance,
                                       DWORD fdwOpen);
    ...
    UINT PASCAL WINBASEAPI waveInOpen(LPHWAVEIN phwi, UINT uDeviceID, LPCWAVEFORMATEX pwfx, DWORD dwCallback, DWORD dwInstance,
                                      DWORD fdwOpen);
    ...
    UINT PASCAL WINBASEAPI midiStreamOpen(LPHMIDISTRM phms, LPUINT puDeviceID, DWORD cMidi, DWORD dwCallback, DWORD dwInstance,
                                          DWORD fdwOpen);
    ...
    UINT PASCAL WINBASEAPI midiOutOpen(LPHMIDIOUT phmo, UINT uDeviceID, DWORD dwCallback, DWORD dwInstance, DWORD fdwOpen);
    ...
    UINT PASCAL WINBASEAPI midiInOpen(LPHMIDIIN phmi, UINT uDeviceID, DWORD dwCallback, DWORD dwInstance, DWORD fdwOpen);
    ...
    UINT PASCAL WINBASEAPI timeSetEvent(UINT uDelay, UINT uResolution, LPTIMECALLBACK fptc, DWORD dwUser, UINT fuEvent);
    ...
    UINT PASCAL WINBASEAPI joySetCapture(HWND hwnd, UINT uJoyID, UINT uPeriod, WINBOOL fChanged);
    ...
    UINT PASCAL WINBASEAPI mmioSetBuffer(HMMIO hmmio, LPSTR pchBuffer, LONG cchBuffer, UINT fuBuffer);
    ...
    LRESULT PASCAL WINBASEAPI mmioSendMessage(HMMIO hmmio, UINT uMsg, LPARAM lParam1, LPARAM lParam2);
    UINT PASCAL WINBASEAPI mmioDescend(HMMIO hmmio, LPMMCKINFO pmmcki, const MMCKINFO FAR* pmmckiParent, UINT fuDescend);
    ...
    WINBOOL PASCAL WINBASEAPI mciSetYieldProc(MCIDEVICEID mciId, YIELDPROC fpYieldProc, DWORD dwYieldData);
...
#define sndAlias(ch0, ch1)    (SND_ALIAS_START + (DWORD)(BYTE)(ch0) | ((DWORD)(BYTE)(ch1) << 8)) 
    ...
    MCIERROR PASCAL WINBASEAPI mciSendStringW(LPCWSTR lpstrCommand, LPWSTR lpstrReturnString, UINT uReturnLength,
                                              HWND hwndCallback);
