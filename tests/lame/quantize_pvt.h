...
int     bin_search_StepSize (lame_internal_flags * const gfc, 
                             ...
                             int const desired_rate, int const start,
                             const FLOAT8 xrpow[576], int l3enc[576]);

int     inner_loop (lame_internal_flags * const gfc, 
                    gr_info * const cod_info, int const max_bits,
                    const FLOAT8 xrpow[576], int l3enc[576]);
...
int     count_bits (lame_internal_flags * const gfc, int * const ix, 
...
void    best_scalefac_store (const lame_internal_flags * gfc, int const gr, int const ch,
