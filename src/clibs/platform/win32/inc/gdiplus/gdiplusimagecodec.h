...
static inline GpStatus GetImageDecoders(UINT numDecoders, UINT size,
...
static inline GpStatus GetImageDecodersSize(UINT *numDecoders, UINT *size)
{
	#ifdef __cplusplus
...
static inline GpStatus GetImageEncoders(UINT numEncoders, UINT size,
...
static inline GpStatus GetImageEncodersSize(UINT *numEncoders, UINT *size)
{
	#ifdef __cplusplus
