...
namespace Parser
{
    ...
    {
        Optimizer::inputFiles.push_back(name);
    }
}
int main(int argc, char* argv[])
{
    ...
    */
    ...
    while (clist)
    {
        ...
        preProcessor = new PreProcessor(buffer, prm_cinclude.GetValue(), prm_sysinclude.GetValue(), true, Optimizer::cparams.prm_trigraph, '#', Optimizer::cparams.prm_charisunsigned,
            !Optimizer::cparams.prm_c99 && !Optimizer::cparams.prm_c1x && !Optimizer::cparams.prm_cplusplus, !Optimizer::cparams.prm_ansi, prm_pipe.GetValue() != "+" ? prm_pipe.GetValue() : "");
