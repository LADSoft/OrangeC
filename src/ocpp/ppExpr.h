...
class ppExpr
{
  public:
    ...
    ppExpr(bool isunsignedchar, Dialect dialect_) :
        define(nullptr), unsignedchar(isunsignedchar), token(nullptr), floatWarned(false), dialect(dialect_)
    {
    }
    ~ppExpr() {}
...
template <typename T, bool(isSymbolChar)(const char*, bool)>
PPINT ppExpr<T, isSymbolChar>::Eval(std::string& line, bool fromConditional)
{
...
template <typename T, bool(isSymbolChar)(const char*, bool)>
PPINT ppExpr<T, isSymbolChar>::primary(std::string& line, bool& isunsigned)
{
    PPINT rv = 0;
...
template <typename T, bool(isSymbolChar)(const char*, bool)>
PPINT ppExpr<T, isSymbolChar>::unary(std::string& line, bool& isunsigned)
{
    if (!token->IsEnd())
    {
...
template <typename T, bool(isSymbolChar)(const char*, bool)>
PPINT ppExpr<T, isSymbolChar>::multiply(std::string& line, bool& isunsigned)
{
    PPINT val1 = unary(line, isunsigned);
    kw keyWord = token->GetKeyword();
...
template <typename T, bool(isSymbolChar)(const char*, bool)>
PPINT ppExpr<T, isSymbolChar>::add(std::string& line, bool& isunsigned)
{
...
template <typename T, bool(isSymbolChar)(const char*, bool)>
PPINT ppExpr<T, isSymbolChar>::shift(std::string& line, bool& isunsigned)
{
...
template <typename T, bool(isSymbolChar)(const char*, bool)>
PPINT ppExpr<T, isSymbolChar>::relation(std::string& line, bool& isunsigned)
{
...
template <typename T, bool(isSymbolChar)(const char*, bool)>
PPINT ppExpr<T, isSymbolChar>::equal(std::string& line, bool& isunsigned)
{
...
template <typename T, bool(isSymbolChar)(const char*, bool)>
PPINT ppExpr<T, isSymbolChar>::and_(std::string& line, bool& isunsigned)
{
...
template <typename T, bool(isSymbolChar)(const char*, bool)>
PPINT ppExpr<T, isSymbolChar>::xor_(std::string& line, bool& isunsigned)
{
...
template <typename T, bool(isSymbolChar)(const char*, bool)>
PPINT ppExpr<T, isSymbolChar>::or_(std::string& line, bool& isunsigned)
{
...
template <typename T, bool(isSymbolChar)(const char*, bool)>
PPINT ppExpr<T, isSymbolChar>::logicaland(std::string& line, bool& isunsigned)
{
...
template <typename T, bool(isSymbolChar)(const char*, bool)>
PPINT ppExpr<T, isSymbolChar>::logicalor(std::string& line, bool& isunsigned)
{
...
template <typename T, bool(isSymbolChar)(const char*, bool)>
PPINT ppExpr<T, isSymbolChar>::conditional(std::string& line, bool& isunsigned)
{
    bool test = false;
...
template <typename T, bool(isSymbolChar)(const char*, bool)>
PPINT ppExpr<T, isSymbolChar>::comma_(std::string& line, bool& isunsigned)
{
    PPINT rv = 0;
