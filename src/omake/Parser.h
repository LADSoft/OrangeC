...
class Parser
{
  ...
  protected:
    ...
    bool ParseAssign(const std::string& left, const std::string& right, bool dooverride, bool exportSpecific,
                     std::shared_ptr<RuleList> ruleList = nullptr);
    bool ParseRecursiveAssign(const std::string& left, const std::string& right, bool dooverride, bool exportSpecific,
                              std::shared_ptr<RuleList> ruleList = nullptr);
    bool ParsePlusAssign(const std::string& left, const std::string& right, bool dooverride, bool exportSpecific,
                         std::shared_ptr<RuleList> ruleList = nullptr);
    bool ParseQuestionAssign(const std::string& left, const std::string& right, bool dooverride, bool exportSpecific,
                             std::shared_ptr<RuleList> ruleList = nullptr);
