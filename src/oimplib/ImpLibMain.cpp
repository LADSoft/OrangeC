                        ...
                        else if (ext == ".dll")
                        {
                            ...
                            switch(dllFile.Read())
                            {
                                case 0:
                                    break;
                                case 1:
                                    std::cout << "Dll file '" << inputFile.c_str() << "' is missing" << std::endl;
                                    break;
                                case 2:
                                    std::cout << "Dll file '" << inputFile.c_str() << "' is invalid format" << std::endl;
                                    break;
                                case 3:
                                    std::cout << "Dll file '" << inputFile.c_str() << "' exports are missing or invalid" << std::endl;
                                    break;
                                return;
                            }
