...
/* __STDC__ - some ANSI compilers define this only to 0, hence the use of
   ...
   update those too.  */
#        if defined(__STDC__) || defined(__cplusplus) || defined(_AIX) || defined(__DECC) || \
            (defined(__mips) && defined(_SYSTYPE_SVR4)) || defined(_MSC_VER) || defined(_WIN32)
...
#    define mp_set_memory_functions __gmp_set_memory_functions
    __GMP_DECLSPEC void mp_set_memory_functions __GMP_PROTO((void* (*)(size_t), void* (*)(void*, size_t, size_t),
                                                             void (*)(void*, size_t))) __GMP_NOTHROW;
#    define mp_get_memory_functions __gmp_get_memory_functions
    __GMP_DECLSPEC void mp_get_memory_functions __GMP_PROTO((void* (**)(size_t), void* (**)(void*, size_t, size_t),
                                                             void (**)(void*, size_t))) __GMP_NOTHROW;
...
#    define gmp_randinit_lc_2exp __gmp_randinit_lc_2exp
    __GMP_DECLSPEC void gmp_randinit_lc_2exp __GMP_PROTO((gmp_randstate_t, mpz_srcptr, mpir_ui, mp_bitcnt_t));
...
#    define mpn_sb_divappr_q __MPN(sb_divappr_q)
    __GMP_DECLSPEC mp_limb_t mpn_sb_divappr_q __GMP_PROTO((mp_ptr qp, mp_ptr np, mp_size_t nn, mp_srcptr dp, mp_size_t dn,
                                                           mp_limb_t dip));
#    define mpn_dc_divappr_q_n __MPN(dc_divappr_q_n)
    __GMP_DECLSPEC mp_limb_t mpn_dc_divappr_q_n __GMP_PROTO((mp_ptr qp, mp_ptr np, mp_srcptr dp, mp_size_t n, mp_limb_t dip,
                                                             mp_ptr tp));
#    define mpn_dc_bdiv_q_n __MPN(dc_bdiv_q_n)
    __GMP_DECLSPEC void mpn_dc_bdiv_q_n __GMP_PROTO((mp_ptr qp, mp_ptr wp, mp_ptr np, mp_srcptr dp, mp_size_t n, mp_limb_t dinv,
                                                     mp_ptr scratch));
#    define mpn_inv_divappr_q_n __MPN(inv_divappr_q_n)
    __GMP_DECLSPEC mp_limb_t mpn_inv_divappr_q_n __GMP_PROTO((mp_ptr qp, mp_ptr np, mp_srcptr dp, mp_size_t n, mp_srcptr dip));
...
#    define mpn_dc_div_q __MPN(dc_div_q)
    __GMP_DECLSPEC mp_limb_t mpn_dc_div_q __GMP_PROTO((mp_ptr qp, mp_ptr np, mp_size_t nn, mp_srcptr dp, mp_size_t dn,
                                                       mp_limb_t dinv));
...
#    define mpn_inv_div_q __MPN(inv_div_q)
    __GMP_DECLSPEC mp_limb_t mpn_inv_div_q __GMP_PROTO((mp_ptr qp, mp_ptr np, mp_size_t nn, mp_srcptr dp, mp_size_t dn,
                                                        mp_srcptr dinv));
#    define mpn_inv_div_qr __MPN(inv_div_qr)
    __GMP_DECLSPEC mp_limb_t mpn_inv_div_qr __GMP_PROTO((mp_ptr qp, mp_ptr np, mp_size_t nn, mp_srcptr dp, mp_size_t dn,
                                                         mp_srcptr dinv));
#    define mpn_inv_div_qr_n __MPN(inv_div_qr_n)
    __GMP_DECLSPEC mp_limb_t mpn_inv_div_qr_n __GMP_PROTO((mp_ptr qp, mp_ptr np, mp_srcptr dp, mp_size_t dn, mp_srcptr dinv));
#    define mpn_dc_div_qr __MPN(dc_div_qr)
    __GMP_DECLSPEC mp_limb_t mpn_dc_div_qr __GMP_PROTO((mp_ptr qp, mp_ptr np, mp_size_t nn, mp_srcptr dp, mp_size_t dn,
                                                        mp_limb_t dinv));
#    define mpn_dc_div_qr_n __MPN(dc_div_qr_n)
    __GMP_DECLSPEC mp_limb_t mpn_dc_div_qr_n __GMP_PROTO((mp_ptr qp, mp_ptr np, mp_srcptr dp, mp_size_t n, mp_limb_t dinv,
                                                          mp_ptr tp));
#    define mpn_sb_div_q __MPN(sb_div_q)
    __GMP_DECLSPEC mp_limb_t mpn_sb_div_q __GMP_PROTO((mp_ptr qp, mp_ptr np, mp_size_t nn, mp_srcptr dp, mp_size_t dn,
                                                       mp_limb_t dinv));
#    define mpn_sb_bdiv_q __MPN(sb_bdiv_q)
    __GMP_DECLSPEC void mpn_sb_bdiv_q __GMP_PROTO((mp_ptr qp, mp_ptr wp, mp_ptr np, mp_size_t nn, mp_srcptr dp, mp_size_t dn,
                                                   mp_limb_t dinv));
#    define mpn_dc_bdiv_q __MPN(dc_bdiv_q)
    __GMP_DECLSPEC void mpn_dc_bdiv_q __GMP_PROTO((mp_ptr qp, mp_ptr np, mp_size_t nn, mp_srcptr dp, mp_size_t dn, mp_limb_t dinv));
#    define mpn_dc_bdiv_qr __MPN(dc_bdiv_qr)
    __GMP_DECLSPEC mp_limb_t mpn_dc_bdiv_qr __GMP_PROTO((mp_ptr qp, mp_ptr np, mp_size_t nn, mp_srcptr dp, mp_size_t dn,
                                                         mp_limb_t dinv));
#    define mpn_dc_bdiv_qr_n __MPN(dc_bdiv_qr_n)
    __GMP_DECLSPEC mp_limb_t mpn_dc_bdiv_qr_n __GMP_PROTO((mp_ptr qp, mp_ptr np, mp_srcptr dp, mp_size_t n, mp_limb_t dinv,
                                                           mp_ptr tp));
#    define mpn_sb_div_qr __MPN(sb_div_qr)
    __GMP_DECLSPEC mp_limb_t mpn_sb_div_qr __GMP_PROTO((mp_ptr qp, mp_ptr np, mp_size_t nn, mp_srcptr dp, mp_size_t dn,
                                                        mp_limb_t dinv));
#    define mpn_sb_bdiv_qr __MPN(sb_bdiv_qr)
    __GMP_DECLSPEC mp_limb_t mpn_sb_bdiv_qr __GMP_PROTO((mp_ptr qp, mp_ptr np, mp_size_t nn, mp_srcptr dp, mp_size_t dn,
                                                         mp_limb_t dinv));
#    define mpn_tdiv_q __MPN(tdiv_q)
    __GMP_DECLSPEC void mpn_tdiv_q __GMP_PROTO((mp_ptr qp, mp_srcptr np, mp_size_t nn, mp_srcptr dp, mp_size_t dn));
#    define mpn_divexact __MPN(divexact)
    __GMP_DECLSPEC void mpn_divexact __GMP_PROTO((mp_ptr qp, mp_srcptr np, mp_size_t nn, mp_srcptr dp, mp_size_t dn));
...
#        if !defined(__GMP_FORCE_mpz_fits_uint_p)
    __GMP_EXTERN_INLINE
#        endif
    int mpz_fits_uint_p(mpz_srcptr __gmp_z) __GMP_NOTHROW { __GMPZ_FITS_UTYPE_P(__gmp_z, __GMP_UINT_MAX); }
#    endif
#    if defined(__GMP_EXTERN_INLINE) || defined(__GMP_FORCE_mpz_fits_ui_p)
#        if !defined(__GMP_FORCE_mpz_fits_ui_p)
    __GMP_EXTERN_INLINE
#        endif
    int mpz_fits_ui_p(mpz_srcptr __gmp_z) __GMP_NOTHROW { __GMPZ_FITS_UTYPE_P(__gmp_z, GMP_UI_MAX); }
#    endif
#    if defined(__GMP_EXTERN_INLINE) || defined(__GMP_FORCE_mpz_fits_ulong_p)
#        if !defined(__GMP_FORCE_mpz_fits_ulong_p)
    __GMP_EXTERN_INLINE
#        endif
    int mpz_fits_ulong_p(mpz_srcptr __gmp_z) __GMP_NOTHROW { __GMPZ_FITS_UTYPE_P(__gmp_z, __GMP_ULONG_MAX); }
#    endif
#    if defined(__GMP_EXTERN_INLINE) || defined(__GMP_FORCE_mpz_fits_ushort_p)
#        if !defined(__GMP_FORCE_mpz_fits_ushort_p)
    __GMP_EXTERN_INLINE
#        endif
    int mpz_fits_ushort_p(mpz_srcptr __gmp_z) __GMP_NOTHROW { __GMPZ_FITS_UTYPE_P(__gmp_z, __GMP_USHRT_MAX); }
#    endif
...
#        if !defined(__GMP_FORCE_mpz_set_q)
    __GMP_EXTERN_INLINE
#        endif
    void mpz_set_q(mpz_ptr __gmp_w, mpq_srcptr __gmp_u) { mpz_tdiv_q(__gmp_w, mpq_numref(__gmp_u), mpq_denref(__gmp_u)); }
#    endif
...
#        if !defined(__GMP_FORCE_mpn_sub_1)
    __GMP_EXTERN_INLINE
#        endif
    mp_limb_t mpn_sub_1(mp_ptr __gmp_dst, mp_srcptr __gmp_src, mp_size_t __gmp_size, mp_limb_t __gmp_n) __GMP_NOTHROW
    {
        mp_limb_t __gmp_c;
...
#        define mpz_cmp_si(Z, SI)                  \
            (__builtin_constant_p(SI) && (SI) == 0 \
                 ? mpz_sgn(Z)                      \
                 : __builtin_constant_p(SI) && (SI) > 0 ? _mpz_cmp_ui(Z, __GMP_CAST(unsigned long int, SI)) : _mpz_cmp_si(Z, SI))
#        define mpq_cmp_ui(Q, NUI, DUI) (__builtin_constant_p(NUI) && (NUI) == 0 ? mpq_sgn(Q) : _mpq_cmp_ui(Q, NUI, DUI))
#        define mpq_cmp_si(q, n, d) \
            (__builtin_constant_p((n) >= 0) && (n) >= 0 ? mpq_cmp_ui(q, __GMP_CAST(unsigned long, n), d) : _mpq_cmp_si(q, n, d))
#    else
