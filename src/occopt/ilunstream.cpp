...
namespace Optimizer
{
    ...
    static void ResolveSymbol(Optimizer::SimpleSymbol*& sym, std::map<int, std::string>& texts, std::vector<Optimizer::SimpleSymbol*>& table);
    ...
    static void ResolveSymbol(std::vector<Optimizer::SimpleSymbol*> symbols, std::map<int, std::string>& texts, std::vector<Optimizer::SimpleSymbol*>& table)
    {
        for (auto&& v : symbols)
        {
