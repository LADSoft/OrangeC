...
#    define _DISK_FORMAT 5 /* format track */
    ...
    int _RTL_FUNC _IMPORT biosdisk(int __cmd, int __drive, int __head, int __track, int __sector, int __nsects, void* __buffer);
...
#    endif /* _REG_DEFS */
    ...
    int _RTL_FUNC _IMPORT _int386(int __intno, union REGS* __inregs, union REGS* __outregs);
