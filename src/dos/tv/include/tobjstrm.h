...
public:
    ...
    _Cdecl fpbase();
    _Cdecl fpbase( const char _FAR *, ios_base::openmode, long protection=0666 );
    _Cdecl fpbase( int );
//    _Cdecl fpbase( int, char _FAR *, int );
    _Cdecl ~fpbase();

    void _Cdecl open( const char _FAR *, ios_base::openmode, long protection=0666 );
...
public:
    ...
    _Cdecl fpstream();
    _Cdecl fpstream( const char _FAR *, ios_base::openmode, long = 0666 );
    _Cdecl fpstream( int );
//    _Cdecl fpstream( int, char _FAR *, int );
    _Cdecl ~fpstream();

    filebuf _FAR * _Cdecl rdbuf();
    void _Cdecl open( const char _FAR *, ios_base::openmode, long = 0666 );
