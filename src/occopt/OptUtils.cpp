...
namespace Optimizer
{
    ...
    Optimizer::IMODE* LookupStoreTemp(Optimizer::IMODE* dest, Optimizer::IMODE* src)
    {
        return src;
    }
    ...
    Optimizer::SimpleExpression *simpleExpressionNode(enum Optimizer::se_type type, Optimizer::SimpleExpression*left, Optimizer::SimpleExpression* right)
    {
        Optimizer::SimpleExpression *rv = (Optimizer::SimpleExpression*)Alloc(sizeof(Optimizer::SimpleExpression));
        rv->type = type;
        rv->left = left;
