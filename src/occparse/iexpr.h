...
namespace Parser
{
    ...
    Optimizer::IMODE* LookupExpression(enum i_ops op, int size, Optimizer::IMODE* left, Optimizer::IMODE* right);
    ...
    Optimizer::IMODE* gen_unary(SYMBOL* funcsp, EXPRESSION* node, int flags, int size, enum i_ops op);
    Optimizer::IMODE* gen_asrhd(SYMBOL* funcsp, EXPRESSION* node, int flags, int size, enum i_ops op);
    Optimizer::IMODE* gen_binary(SYMBOL* funcsp, EXPRESSION* node, int flags, int size, enum i_ops op);
    Optimizer::IMODE* gen_udivide(SYMBOL* funcsp, EXPRESSION* node, int flags, int size, enum i_ops op, bool mod);
    Optimizer::IMODE* gen_sdivide(SYMBOL* funcsp, EXPRESSION* node, int flags, int size, enum i_ops op, bool mod);
    ...
    Optimizer::IMODE* gen_aincdec(SYMBOL* funcsp, EXPRESSION* node, int flags, int size, enum i_ops op);
    ...
    Optimizer::IMODE* gen_set(EXPRESSION* node, SYMBOL* funcsp, i_ops btype);
