...
enum st_type
{
    ...
    st_func, st_lref, st_rref, st_struct, st_union, st_class, st_enum, st_memberptr, st_aggregate, st_ellipse, st_any
};
struct SimpleType
{
    SimpleType *btp;
...
enum e_scc_type
{
    scc_none, scc_static, scc_localstatic, scc_auto, scc_register, scc_global, scc_external, scc_templateparam,
    scc_parameter, scc_catchvar, scc_type, scc_typedef, scc_member, scc_mutable, scc_cast, scc_defunc, scc_label, scc_ulabel,
    scc_overloads, scc_constant, scc_enumconstant, scc_absolute,
    scc_friendlist, scc_const, scc_tconst, scc_classmember, scc_constexpr,
    scc_memberreg, scc_namespace, scc_namespacealias, scc_temp, scc_virtual
};
...
{
    se_none,
    se_add, se_sub, se_uminus, se_i, se_ui, se_f, se_fi, se_fc, se_const, se_absolute, se_auto, se_global, se_threadlocal, se_pc, se_labcon, se_structelem, se_func, se_tempref,
