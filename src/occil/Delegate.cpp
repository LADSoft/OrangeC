...
namespace occmsil
{
    ...
    static Class* GetDelegateClass(char* name, Optimizer::LIST* syms, Optimizer::SimpleType* returntp, Operand*& ctor)
    {
        ...
        Method* method = peLib->AllocateMethod(sig, Qualifiers::Public | Qualifiers::HideBySig | Qualifiers::SpecialName | Qualifiers::RTSpecialName | Qualifiers::Managed | Qualifiers::Runtime);
        cls->Add(method);
        ...
        method = peLib->AllocateMethod(sig, Qualifiers::Public | Qualifiers::HideBySig | Qualifiers::Virtual | Qualifiers::NewSlot | Qualifiers::Managed | Qualifiers::Runtime);
        cls->Add(method);
