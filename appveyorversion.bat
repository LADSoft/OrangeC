...
echo #define COPYRIGHT "Copyright (C) LADSoft 2006-2020" >> c:\orangec\src\version.h
echo #define LIBRARY_COPYRIGHT "Copyright (C) LADSoft 1994-2020" >> c:\orangec\src\version.h
