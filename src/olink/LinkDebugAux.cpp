...
int LinkerColumnsWithNameVirtualTable::Filter(void *cursor, int idxNum, const char *idxStr,
...
char *LinkerColumnsWithNameVirtualTable::GetVTabDeclarator()
{
    return (char *)declarator.c_str();
}
char *LinkerColumnsWithNameVirtualTable::GetName()
{
