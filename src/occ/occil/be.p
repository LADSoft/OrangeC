...
void flush_peep(struct SimpleSymbol* funcsp, QUAD *list);
...
void oa_putconst(int sz, SimpleExpression* offset, bool doSign);
...
void oa_gen_strlab(struct SimpleSymbol* sp);
...
void oa_gensrref(struct SimpleSymbol* sp, int val, int type);
void oa_genref(struct SimpleSymbol* sp, int offset);
void oa_genlabref(int label, int offset);
void oa_genpcref(struct SimpleSymbol* sp, int offset);
void oa_genstorage(int nbytes);
void oa_gen_labref(int n);
void oa_gen_labdifref(int n1, int n2);
void oa_exitseg();
void oa_enterseg(e_sg seg);
void oa_gen_virtual(struct SimpleSymbol* sp, int data);
void oa_gen_endvirtual(struct SimpleSymbol* sp);
void oa_gen_vtt(VTABENTRY *entry, struct SimpleSymbol* func);
void oa_gen_vc1(struct SimpleSymbol* func);
void oa_gen_importThunk(struct SimpleSymbol* func);
...
void oa_enter_type(struct SimpleSymbol* sp);
void oa_trailer(void);
void oa_adjust_codelab(void *select, int offset);
void oa_globaldef(struct SimpleSymbol* sp);
void oa_localdef(struct SimpleSymbol* sp);
void oa_localstaticdef(struct SimpleSymbol* sp);
void oa_output_alias(char* name, char* alias);
void oa_put_extern(struct SimpleSymbol* sp, int code);
void oa_put_impfunc(struct SimpleSymbol* sp, char* file);
void oa_put_expfunc(struct SimpleSymbol* sp);
...
bool msil_managed(struct SimpleSymbol* sp);
void msil_create_property(struct SimpleSymbol* property, struct SimpleSymbol* getter, struct SimpleSymbol* setter);
int oa_main_preprocess(void);
void oa_main_postprocess(bool errors);
void GetOutputFileName(char* name, char* temp, bool obj);
void NextOutputFileName();
void *msil_alloc(size_t size);
char* msil_strdup(char* s);
TYPE * clonetp(TYPE *tp, bool shallow);
struct SimpleSymbol*  clonesp(struct SimpleSymbol* sp, bool shallow);
