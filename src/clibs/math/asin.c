...
float _RTL_FUNC asinf(float x)
{
    return asin(x);
}
long double _RTL_FUNC asinl(long double x)
{
    return asin(x);
}


double _RTL_FUNC acos(x)
double x;
{
double z;
...
float _RTL_FUNC acosf(float x)
{
    return acos(x);
}
long double _RTL_FUNC acosl(long double x)
{
    return acos(x);
}