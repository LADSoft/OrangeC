...
namespace DotNetPELib
{
    ...
    bool EventList::HasIndexOverflow(size_t sizes[MaxTables + ExtraIndexes]) const
    {
        return Large(sizes[tEvent]);
    }
    ...
    bool PropertyList::HasIndexOverflow(size_t sizes[MaxTables + ExtraIndexes]) const
    {
        return Large(sizes[tProperty]);
    }
    ...
    bool GenericRef::HasIndexOverflow(size_t sizes[MaxTables + ExtraIndexes]) const
    {
        return Large(sizes[tGenericParam]);
    }
    bool Implementation::HasIndexOverflow(size_t sizes[MaxTables + ExtraIndexes]) const
    {
        return Large(sizes[tFile]) ||
            Large(sizes[tAssemblyRef]);
    }
    ...
    size_t StandaloneSigTableEntry::Get(size_t sizes[MaxTables + ExtraIndexes], Byte *src)
    {
        return signatureIndex_.Get(sizes, src);
    }
    ...
    size_t ModuleRefTableEntry::Get(size_t sizes[MaxTables + ExtraIndexes], Byte *src)
    {
        return nameIndex_.Get(sizes, src);
    }
    size_t TypeSpecTableEntry::Render(size_t sizes[MaxTables + ExtraIndexes], Byte *dest) const
    {
        return signatureIndex_.Render(sizes, dest);
    }
    size_t TypeSpecTableEntry::Get(size_t sizes[MaxTables + ExtraIndexes], Byte *src)
    {
        return signatureIndex_.Get(sizes, src);
    }
