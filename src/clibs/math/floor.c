...
float _RTL_FUNC ceilf(float x)
{
    return ceil(x);
}
long double _RTL_FUNC ceill(long double x)
{
    return ceil(x);
}
...
float _RTL_FUNC floorf(float x)
{
    return floor(x);
}
long double _RTL_FUNC floorl(long double x)
{
    return floor(x);
}

double _RTL_FUNC frexp( x, pw2 )
double x;
int *pw2;
{
union
...
float _RTL_FUNC frexpf(float x, int *pw2)
{
    return frexp(x, pw2);
}
long double _RTL_FUNC frexpl(long double x, int *pw2)
{
    return frexp(x, pw2);
}
...
float _RTL_FUNC ldexpf(float x, int pw2)
{
    return ldexp(x, pw2);
}
long double _RTL_FUNC ldexpl(long double x, int pw2)
{
    return ldexp(x, pw2);
}