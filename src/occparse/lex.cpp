...
KEYWORD keywords[] = {
    ...
    */
    ...
    {"__c11_atomic_store", 18, kw_atomic_store, 0, TT_VAR},
    {"__c11_atomic_load", 17, kw_atomic_load, 0, TT_VAR},
    ...
    {"__atomic_load_n", 15, kw_atomic_load, 0, TT_VAR},
    {"__atomic_store_n", 16, kw_atomic_store, 0, TT_VAR},
