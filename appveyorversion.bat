...
echo #define COPYRIGHT "Copyright (C) LADSoft 2006-2026" >> c:\orangec\src\version.h
echo #define LIBRARY_COPYRIGHT "Copyright (C) LADSoft 1994-2026" >> c:\orangec\src\version.h
