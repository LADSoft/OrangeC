...
{
  public:
    MakeStubs(PreProcessor<T, isSymbolChar, embed_elements>& Processor, bool UserOnly, bool PhonyTargets, const std::string& InputFile,
  ...
  private:
    PreProcessor<T, isSymbolChar, embed_elements>& preProcessor;
    bool userOnly;
    bool phonyTargets;
