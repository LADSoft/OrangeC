...
#if defined (__BORLANDC__) || defined (__ORANGEC__)
...
#if (defined (__BORLANDC__) || defined(__ORANGEC__) || defined (__WATCOMC__)) && defined (_STLP_USE_NEW_C_HEADERS)
...
/*
   ...
   this problem.
*/
#if !(defined(__HP_aCC) && defined(_STLP_DEBUG)) && !defined (__ORANGEC__)
using ::hypot;
#endif
using ::ldexp;
using ::log;
