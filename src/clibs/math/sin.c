...
float _RTL_FUNC sinf(float x)
{
    return sin(x);
}
long double _RTL_FUNC sinl(long double x)
{
    return sin(x);
}


double _RTL_FUNC cos(x)
double x;
{
double y, z, zz;
long i;
...
float _RTL_FUNC cosf(float x)
{
    return cos(x);
}
long double _RTL_FUNC cosl(long double x)
{
    return cos(x);
}