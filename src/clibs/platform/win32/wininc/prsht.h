...
*/ 
#ifndef _GNU_H_PROPSHT_H
#define _GNU_H_PROPSHT_H

#include <win32/prdef.h>
#include <win32/prmsg.h>

#ifndef RC_INVOKED
#include <win32/prmacro.h>
#include <win32/prstruc.h>
#include <win32/prfunc.h>
#endif

#endif /* _GNU_H_PROPSHT_H */
