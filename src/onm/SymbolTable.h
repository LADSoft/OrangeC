...
{
public:
    enum SymbolType { Absolute, BSSGlobal, BSSLocal, Common, DataGlobal, DataLocal, Import, Debug, ROGlobal, ROLocal, Section, TextGlobal, TextLocal, Undefined, ObjFileSpecific };
    Symbol() { }
    Symbol(std::string file, std::string name, ObjInt Offset, SymbolType Type) : fileName(file), symbolName(name), 
