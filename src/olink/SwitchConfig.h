...
class SwitchConfig : public xmlVisitor, public CmdSwitchString
{
  public:
    ...
    int RunApp(const std::string& path, const std::string& file, const std::string& debugFile, bool verbose, std::string outDefFile,
               std::string outImportLibrary, bool bindtable, bool unloadtable, std::string delayload);
