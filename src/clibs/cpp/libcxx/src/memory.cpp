...
//#include <stdatomic.h>
#ifdef __ORANGEC__
#define    _memory_order_seq_cst 5

#define __sync_add_and_fetch(__a__,__m__) __atomic_modify( __a__, +=, __m__, _memory_order_seq_cst )
#define __sync_bool_compare_and_swap(__a__, __e__, __m__) (__atomic_cmpswp( __a__, __e__, __m__, _memory_order_seq_cst, _memory_order_seq_cst ) == __m__)
#endif __
