...
class Runner
{
  ...
  protected:
    static void CallRunner(Runner* runner, std::list<std::shared_ptr<RuleList>>* ruleStack, Depends* depend,
                           EnvironmentStrings* env, bool keepGoing, std::promise<int> promise);
