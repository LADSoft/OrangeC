@echo off
     ...
     if "%ORANGEC_HOME%" NEQ "" (
         ...
         del /Q ..\include\win32\*.*
         del /Q ..\include\sys\*.*
         omake -DCOMPILER=MS clean -j:%NUMBER_OF_CORES%
         omake -DCOMPILER=CLANG clean -j:%NUMBER_OF_CORES%
         omake -DCOMPILER=MINGW64 clean -j:%NUMBER_OF_CORES%
