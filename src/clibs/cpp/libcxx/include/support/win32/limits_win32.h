...
#define __builtin_nan(__dummy)   _NAN
#define __builtin_nanf(__dummy)  _NAN
#define __builtin_nanl(__dummmy) _NAN
// this isn't right for signalling nans -DAL
#define __builtin_nans(__dummy)  _NAN
#define __builtin_nansf(__dummy) _NAN
#define __builtin_nansl(__dummy) _NAN
