...
namespace Optimizer
{
    ...
    static void iop_passthrough(Optimizer::QUAD* q)
    {
        oprintf(icdFile, "PASSTHROUGH\n");
    }
    static void iop_datapassthrough(Optimizer::QUAD* q)
    {
    ...
    static void iop_goto(Optimizer::QUAD* q)
    {
    ...
    static void iop_gosub(Optimizer::QUAD* q)
    {
        putsingle(q, q->dc.left, "GOSUB");
    }

    static void iop_fargosub(Optimizer::QUAD* q)
    {
        putsingle(q, q->dc.left, "FARGOSUB");
    }
    /*-------------------------------------------------------------------------*/

    static void iop_trap(Optimizer::QUAD* q)
    {
    ...
    static void iop_int(Optimizer::QUAD* q)
    {
    ...
    static void iop_rett(Optimizer::QUAD* q)
    {
    ...
    static void iop_add(Optimizer::QUAD* q)
    {
        putbin(q, "+");
    }
    ...
    static void iop_sub(Optimizer::QUAD* q)
    {
        putbin(q, "-");
    }
    ...
    static void iop_udiv(Optimizer::QUAD* q)
    {
        putbin(q, "U/");
    }
    ...
    static void iop_umod(Optimizer::QUAD* q)
    {
        putbin(q, "U%");
    }
    ...
    static void iop_sdiv(Optimizer::QUAD* q)
    {
        putbin(q, "S/");
    }
    ...
    static void iop_smod(Optimizer::QUAD* q)
    {
        putbin(q, "S%");
    }

    /*-------------------------------------------------------------------------*/
    static void iop_muluh(Optimizer::QUAD* q)
    {
        putbin(q, "U*H");
    }
    static void iop_mulsh(Optimizer::QUAD* q)
    {
        putbin(q, "S*H");
    }

    static void iop_mul(Optimizer::QUAD* q)
    {
        putbin(q, "*");
    }
    ...
    static void iop_lsl(Optimizer::QUAD* q)
    {
        putbin(q, "<<");
    }
    ...
    static void iop_lsr(Optimizer::QUAD* q)
    {
        putbin(q, "U>>");
    }
    ...
    static void iop_asr(Optimizer::QUAD* q)
    {
        putbin(q, "S>>");
    }
    ...
    static void iop_and(Optimizer::QUAD* q)
    {
        putbin(q, "&");
    }
    ...
    static void iop_or(Optimizer::QUAD* q)
    {
        putbin(q, "|");
    }
    ...
    static void iop_eor(Optimizer::QUAD* q)
    {
        putbin(q, "^");
    }
    ...
    static void iop_neg(Optimizer::QUAD* q)
    {
        putunary(q, "-");
    }
    ...
    static void iop_not(Optimizer::QUAD* q)
    {
        putunary(q, "~");
    }
    ...
    static void iop_assn(Optimizer::QUAD* q)
    {
        putunary(q, "");
    }
    ...
    static void iop_genword(Optimizer::QUAD* q)
    {
    ...
    static void iop_jc(Optimizer::QUAD* q)
    {
        putjmp(q, "U<");
    }
    ...
    static void iop_ja(Optimizer::QUAD* q)
    {
        putjmp(q, "U>");
    }
    ...
    static void iop_je(Optimizer::QUAD* q)
    {
        putjmp(q, "==");
    }
    ...
    static void iop_jnc(Optimizer::QUAD* q)
    {
        putjmp(q, "U>=");
    }
    ...
    static void iop_jbe(Optimizer::QUAD* q)
    {
        putjmp(q, "U<=");
    }
    ...
    static void iop_jne(Optimizer::QUAD* q)
    {
        putjmp(q, "!=");
    }
    ...
    static void iop_jl(Optimizer::QUAD* q)
    {
        putjmp(q, "S<");
    }
    ...
    static void iop_jg(Optimizer::QUAD* q)
    {
        putjmp(q, "S>");
    }
    ...
    static void iop_jle(Optimizer::QUAD* q)
    {
        putjmp(q, "S<=");
    }
    ...
    static void iop_jge(Optimizer::QUAD* q)
    {
        putjmp(q, "S>=");
    }
    ...
    static void iop_setc(Optimizer::QUAD* q)
    {
        putset(q, "U<");
    }
    ...
    static void iop_seta(Optimizer::QUAD* q)
    {
        putset(q, "U>");
    }
    ...
    static void iop_sete(Optimizer::QUAD* q)
    {
        putset(q, "==");
    }
    ...
    static void iop_setnc(Optimizer::QUAD* q)
    {
        putset(q, "U>=");
    }
    ...
    static void iop_setbe(Optimizer::QUAD* q)
    {
        putset(q, "U<=");
    }
    ...
    static void iop_setne(Optimizer::QUAD* q)
    {
        putset(q, "!=");
    }
    ...
    /*-------------------------------------------------------------------------*/
        ...
        static void iop_setl(Optimizer::QUAD* q)
    {
        putset(q, "S<");
    }
    ...
    static void iop_setg(Optimizer::QUAD* q)
    {
        putset(q, "S>");
    }
    ...
    static void iop_setle(Optimizer::QUAD* q)
    {
        putset(q, "S<=");
    }
    ...
    static void iop_setge(Optimizer::QUAD* q)
    {
        putset(q, "S>=");
    }
    ...
    static void iop_cppini(Optimizer::QUAD* q)
    {
    ...
    static void iop_varstart(Optimizer::QUAD* q)
    {
    ...
    static void iop_pushcontext(Optimizer::QUAD* q)
    {
        oprintf(icdFile, "\tPUSHCONTEXT", q->dc.v.label);
    }
    static void iop_popcontext(Optimizer::QUAD* q)
    {
        oprintf(icdFile, "\tPOPCONTEXT", q->dc.v.label);
    }
    static void iop_loadcontext(Optimizer::QUAD* q)
    {
        oprintf(icdFile, "\tLOADCONTEXT", q->dc.v.label);
    }
    static void iop_unloadcontext(Optimizer::QUAD* q)
    {
    ...
    static void iop_expressiontag(Optimizer::QUAD* q)
    {
        oprintf(icdFile, "\tEXPR TAG\t%d", q->dc.v.label);
    }
    static void iop_tag(Optimizer::QUAD* q)
    {
        oprintf(icdFile, "\tTAG");
    }
    static void iop_seh(Optimizer::QUAD* q)
    {
