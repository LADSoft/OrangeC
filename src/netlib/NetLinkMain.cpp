...
This program is a simple linker that links a custom file format
generated by the OCCIL/MSIL C compiler.   It can generate
.net framework or .net core programs.
