...
long double lgammax(long double x)
{
  int local_sgngam=0;
...
int main()
{
    printf("%25.20Le;%25.20Le\n", lgammax(-100.1),lgammal(-100.1));
    printf("%25.20Le;%25.20Le\n", lgammax(-50.2), lgammal(-50.2));
    printf("%25.20Le;%25.20Le\n", lgammax(-35.1), lgammal(-35.1));
    printf("%25.20Le;%25.20Le\n", lgammax(-33.1), lgammal(-33.1));
    printf("%25.20Le;%25.20Le\n", lgammax(-30.1), lgammal(-30.1));
    printf("%25.20Le;%25.20Le\n", lgammax(-20.1), lgammal(-20.1));
    printf("%25.20Le;%25.20Le\n", lgammax(-10.1), lgammal(-10.1));
    printf("%25.20Le;%25.20Le\n", lgammax(0), lgammal(0));
    printf("%25.20Le;%25.20Le\n", lgammax(2), lgammal(2));
    printf("%25.20Le;%25.20Le\n", lgammax(3), lgammal(3));
    printf("%25.20Le;%25.20Le\n", lgammax(5), lgammal(5));
    printf("%25.20Le;%25.20Le\n", lgammax(10), lgammal(10));
    printf("%25.20Le;%25.20Le\n", lgammax(20), lgammal(20));
    printf("%25.20Le;%25.20Le\n", lgammax(50), lgammal(50));
    printf("%25.20Le;%25.20Le\n", lgammax(100), lgammal(100));
}