/* Theme Manager schema definitions */

/* Starting with Vista, thschema.h is obsolete */
#if ((NTDDI_VERSION >= NTDDI_VISTA || defined(_VSSYM32_H)) && !defined(SCHEMA_VERIFY_VSSYM32))
#pragma message ("tmschema.h is obsolete, use vssym32.h")
#include "vssym32.h"
...
#endif /* #if ((NTDDI_VERSION >= NTDDI_VISTA || defined(_VSSYM32_H)) && !defined(SCHEMA_VERIFY_VSSYM32)) */
