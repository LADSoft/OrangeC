...
template <int N>
using fnv1a64_arr = fnv1a_arr<uint64_t, N, UINT64_C(1099511628211), UINT64_C(14695981039346656037)>;
template <int N>
using fnv1a32_arr = fnv1a_arr<uint32_t, N, UINT32_C(16777619), UINT32_C(2166136261)>;
template <int N>
