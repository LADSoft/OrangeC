/* 
   ...
   Include this file if you wish to use the Windows32 API for ioctl
...
*/ 
#ifndef _GNU_H_WINIOCTL_H
#define _GNU_H_WINIOCTL_H

#include <win32/winiodef.h>

#ifndef RC_INVOKED
#include <win32/winiomac.h>
#include <win32/winiostr.h>
#endif

#endif /* _GNU_H_WINIOCTL_H */
